...
// async function main() {
  // console.log('🎟️  Welcome to the Ticket Purchase CLI\n');

  // try {
    // const accountId = parseInt(await ask('Enter Account ID: '), 10);
    // const adultCount = parseInt(await ask('Number of ADULT tickets: '), 10);
    // const childCount = parseInt(await ask('Number of CHILD tickets: '), 10);
    // const infantCount = parseInt(await ask('Number of INFANT tickets: '), 10);
